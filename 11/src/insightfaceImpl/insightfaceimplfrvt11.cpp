...
#include "insightfaceimplfrvt11.h"

using namespace std;
using namespace FRVT;
using namespace FRVT_11;

InsightfaceImplFRVT11::InsightfaceImplFRVT11() {}

InsightfaceImplFRVT11::~InsightfaceImplFRVT11() {}

ReturnStatus
InsightfaceImplFRVT11::initialize(const std::string &configDir)
{
    return ReturnStatus(ReturnCode::Success);
}

ReturnStatus
InsightfaceImplFRVT11::createTemplate(
...
ReturnStatus
InsightfaceImplFRVT11::matchTemplates(
...
{
    return std::make_shared<InsightfaceImplFRVT11>();
}
